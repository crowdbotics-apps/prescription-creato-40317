...
## Project Structure
    ...
    ├── prescription_creato_40317  # Django project configurations
...
1. Clone this repo and `cd prescription_creato_40317`
...
2. Clone this repo and `cd prescription_creato_40317`
